...
def main():
    ...
    parser.add_argument(
        "--i_folder", help="The folder containing the exp_X directories", default="ps_tst/"
    )
    ...
    for exp_dir in tqdm(exp_dirs):
        ...
        avgs.append(np.average(vals))
        medians.append(np.median(vals))
        upqs.append(np.percentile(vals, 25))
        lwqs.append(np.percentile(vals, 75))
